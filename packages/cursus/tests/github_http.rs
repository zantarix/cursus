...
// Minimal JSON for a PR response (all non-Option fields required by octocrab).
const PR_JSON: &str = r#"{
	...
	"review_comment_url": "https://api.github.com/repos/owner/repo/pulls/comments/7",
	...
	"title": "Test PR",
	"user": {
		"login": "user", "id": 1, "node_id": "user_node",
