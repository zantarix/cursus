...
- **2026-05-12**: The decorator `SignedCommitGit` was renamed to `GitHubSignedCommit` in [ADR-058](058-verified-release-commits-on-gitlab-via-web-commits-api.md) for naming symmetry with the GitLab equivalent introduced there.
